  ...
  return (
    <div className="pt-8 text-white font-bold">
      <div className="flex flex-col items-center">
        <div className="bg-red-800 w-[410px] shadow-2xl hover:shadow-blue-900 rounded-md p-3">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            className="w-12 bg-black pl-2" type="number" />
          </div>
        ...
        {password && <p className="font-normal text-white mt-5">Generate Password: <span className="font-bold">{password}</span></p>}
        </div>
      </div>
    </div>
  );
